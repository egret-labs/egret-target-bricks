...
BK.Script.loadlib("GameRes://script/core/io/skeletonAsyc.js");
 ...
 */
skeletonAnimationAsyc("GameRes://resource/spine/suit/default/role/role",1,startCB,completeCB,endCB,function(ani){
	...
	{
	   setAccessoryAsyc(ani,"GameRes://resource/spine/suit/default/" + accArray[i] + "/dress",function(){
...
setAccessoryWithInfoAsyc(ani,"GameRes://resource/spine/bubble/1/dress", "你好",function(){});

//添加动画

setAccessoryAnimationAsyc(ani,"GameRes://resource/spine/action/archery/action","anim1",function(){
			ani.setAnimation(12312,"anim1",true)
		});
//setAccessoryAnimationAsyc(ani,"GameRes://resource/spine/action/activityleg/action","anim2",function(){});
