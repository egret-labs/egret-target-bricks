...
class BKUIManager
{
    ...
    initMasterJoinerSelectUI(selectCallback:(isMaster:boolean)=>void)
    {
    ...
    updateSelectText(selectNum:number)
    {
...
function addQAVView(openId:string) {
    var isExist = false;
    for (let index = 0; index < currPlayerOpenIds.length; index++) {
        const playerOpenId = currPlayerOpenIds[index];
