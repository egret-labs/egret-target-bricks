...
// BK.Script.loadlib("GameRes://script/core/ui/ui_event.js");
BK.Director.root.position = { x: 0, y: BK.Director.screenPixelSize.height-400 }
// var clipNode = new BK.ClipRectNode(0, 0, 2048, -2048);
var clipNode = new BK.Node()
//clipNode.scale = {x: 2, y: 2, z:1};
// clipNode.position = {x: 50, y: 50, z: 0};

BK.Director.root.addChild(clipNode);

var tex = new BK.Texture("GameRes://resource/assets/bg.jpg");
var sp = new BK.Sprite(1000, 1000, tex, 0, 1, 1, 1);
sp.position = {x:0,y:-sp.size.height+300}
clipNode.addChild(sp);
