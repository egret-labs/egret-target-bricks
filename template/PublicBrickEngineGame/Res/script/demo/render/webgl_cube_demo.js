...
var indexsData = new BK.Buffer(144/2,false);
...
var proj_matrix = get_projection(20, BK.Director.screenPixelSize.width / BK.Director.screenPixelSize.height, 1, 100);
...
glTicker.setTickerCallBack(function(ts, duration)
                           ...
                           gl.glCommit();
                           BK.Script.log(1,1,"commit ts="+ts);
