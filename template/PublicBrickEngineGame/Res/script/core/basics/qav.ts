...
(function (global:any, factory) {
  ...
  class QAV {
    ...
    ///Public///
    public setQAVCfg(cfg: QQAVRoomConfig) {
      this.qavCfg = cfg;
    }
    ...
    public initQAV(cfg: QQAVRoomConfig, callback: (errCode: number, cmd: string, data: any) => void) {
      this.setQAVCfg(cfg);
    ...
    public initQAVRoom(cfg: QQAVRoomConfig, callback: (errCode: number, cmd: string, data: any) => void) {
    ...
    public enterQAVRoom(cfg: QQAVRoomConfig, callback: (errCode: number, cmd: string, data: any) => void) {
    ...
    public initAndEnterRoom(cfg: QQAVRoomConfig, callback: (errCode: number, cmd: string, data: any) => void) {
      ...
      this.initQAVRoom(cfg, function (initErrCode: number, initCmd: string, initData: any) {
        if (initErrCode == 0) {
          this.log("initAndEnterRoom step2 enterRoom");
          this.enterQAVRoom(cfg, function (errCode: number, cmd: string, data: any) {
            if (errCode == 0) {
