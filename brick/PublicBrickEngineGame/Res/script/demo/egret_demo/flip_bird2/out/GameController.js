var GameController = (function () {
    ...
    GameController.GameInit = function () {
        ...
        this._instance.gameScene.removePause();
    ...
    GameController.loadLevelData = function () {
        ...
        //增加敌人的碰撞半径和玩家的碰撞半径
        GameData.enemyRadius = levelData.properties.enemyRadius;
        GameData.playerRadius = levelData.properties.playerRadius;
        GameData.cycle = 0;
        GameData.maxMileage = 30000;
    };
    /**
     * 游戏结束
     */
