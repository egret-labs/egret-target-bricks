...
(function (starlingswf) {
    ...
    var SwfUpdateManager = (function () {
        ...
        SwfUpdateManager.createSwfUpdateManager = function (fps) {
            ...
            egret.startTick(updateManager.update, updateManager);
        ...
        SwfUpdateManager.prototype.update = function (timestamp) {
            var time = timestamp - SwfUpdateManager.lastTime;
            ...
            SwfUpdateManager.lastTime = timestamp;
        };
